...
public class SkystoneTrackerVuforia implements SkystoneTracker {
    ...
    public SkystoneTrackerVuforia(double alpha) {
        this.xSmooth = new ExponentialMovingAverage(0.5);
        this.ySmooth = new ExponentialMovingAverage(0.5);
        this.zSmooth = new ExponentialMovingAverage(0.5);
    }
    ...
    public Float getAngle() {
        if (lastKnownLocation != null) {
            float robotAngle = Orientation.getOrientation(lastKnownLocation, AxesReference.EXTRINSIC, AxesOrder.XYZ, AngleUnit.DEGREES).thirdAngle;
            return robotAngle;
        }
